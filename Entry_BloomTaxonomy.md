...
### C. App Demo
I've prepared an application to run the trained XGBoost model in evaluating text. You may access the "ML-based Bloom Classifier" app (url = "appapps-44hva3nca3x7r2qvoapbxw.streamlit.app"). Password is "education".
<p align="center">
